...
def dev_agent_node(state):
    ...
    tools = [
        ...
        generate_image_tool, search_flights, run_terminal_command, learn_routine, edit_routine, delete_routine, get_routines, control_routine_notifications, control_routine_schedule, control_routine_condition, control_routine_cooldown,
...
def chat_agent_node(state: AgentState):
    ...
    chat_tools = [
        ...
        recipe_expert, log_meal, relay_local_payload, learn_routine, edit_routine, delete_routine, get_routines, control_routine_notifications, control_routine_schedule, control_routine_condition, control_routine_cooldown, search_supermarket_prices,
...
def home_agent_node(state):
    ...
    tools_to_bind = [
        ...
        google_calendar_tool, google_tasks_tool, recipe_expert, log_meal, learn_routine, edit_routine, delete_routine, get_routines, control_routine_notifications, control_routine_schedule, control_routine_condition, control_routine_cooldown, search_supermarket_prices,
        get_fit_summary
    ]
...
all_tools = [
    ...
    recipe_expert, log_meal, create_file_tool, run_terminal_command, search_google_places, search_flights, learn_routine, edit_routine, delete_routine, get_routines, control_routine_notifications, control_routine_schedule, control_routine_condition, control_routine_cooldown, browse_url,
