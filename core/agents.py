...
from tools.system import (
    ...
    mail_manager, github_manager, control_vacuum, control_spotify, learn_routine, get_routines, control_routine_notifications, create_file_tool, run_terminal_command, generate_image_tool, post_to_linkedin, get_current_location, get_fit_summary,
...
def dev_agent_node(state):
    ...
    tools = [
        ...
        generate_image_tool, search_flights, run_terminal_command, learn_routine, get_routines, control_routine_notifications,
...
def chat_agent_node(state: AgentState):
    ...
    chat_tools = [
        ...
        recipe_expert, log_meal, relay_local_payload, learn_routine, get_routines, control_routine_notifications, search_supermarket_prices,
...
def home_agent_node(state):
    ...
    tools_to_bind = [
        ...
        google_calendar_tool, google_tasks_tool, recipe_expert, log_meal, learn_routine, get_routines, control_routine_notifications, search_supermarket_prices,
        get_fit_summary
    ]
...
all_tools = [
    ...
    recipe_expert, log_meal, create_file_tool, run_terminal_command, search_google_places, search_flights, learn_routine, get_routines, control_routine_notifications, browse_url,
