...
def test_get_gmail_service_reauthorizes_after_invalid_grant(monkeypatch, tmp_path):
    ...
    stale_creds.refresh.side_effect = RefreshError("invalid_grant: Token has been revoked.")
